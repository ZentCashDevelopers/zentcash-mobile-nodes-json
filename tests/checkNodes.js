...
const data = require('../zentcash-mobile-nodes.json')
...
function checkTestNode (node) {
  ...
  return request({ url: 'https://raw.githubusercontent.com/ZentCashDevelopers/zentcash-mobile-nodes-json/master/zentcash-mobile-nodes.json', json: true })
    .then(data => {
